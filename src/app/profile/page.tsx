...
export default function ProfilePage() {
  ...
  return (
    <div className="bg-gray-50 flex flex-col flex-1 pb-16 md:pb-0">
      <div className="relative text-white text-center">
        <div className="bg-primary rounded-b-3xl pt-8 pb-16">
           <h1 className="text-3xl font-bold text-primary-foreground">Account</h1>
        </div>
        <div className="absolute top-20 left-1/2 -translate-x-1/2 w-full px-4">
             <Card className="shadow-xl rounded-2xl w-full max-w-md mx-auto">
                 <CardContent className="p-6">
                    {loading ? (
                        <div className="h-16 w-full animate-pulse" />
                    ) : user ? (
                      <div className="flex flex-col items-center text-center">
                          <Avatar className="h-20 w-20 mb-3 border-4 border-white shadow-md -mt-16 bg-gray-200">
      ...
      <div className="p-4 pt-16 space-y-4 max-w-md mx-auto w-full">
