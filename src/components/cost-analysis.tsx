      ...
      <CardContent className="space-y-6">
        <Tabs defaultValue="andamento" className="w-full">
          <TabsList className="grid w-full grid-cols-4 bg-gray-100 rounded-full h-12 p-1.5">
            <TabsTrigger value="andamento" className="rounded-full text-[0.625rem] sm:text-base data-[state=active]:bg-white data-[state=active]:shadow-md">ANDAMENTO</TabsTrigger>
            <TabsTrigger value="variazioni" className="rounded-full text-[0.625rem] data-[state=active]:bg-white data-[state=active]:shadow-md">VARIAZIONI</TabsTrigger>
            <TabsTrigger value="anni" className="rounded-full text-[0.625rem] data-[state=active]:bg-white data-[state=active]:shadow-md">ANNI</TabsTrigger>
            <TabsTrigger value="mesi" className="rounded-full text-[0.625rem] data-[state=active]:bg-white data-[state=active]:shadow-md">MESI</TabsTrigger>
          </TabsList>
